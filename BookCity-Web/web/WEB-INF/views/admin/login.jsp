...
<div id="wrapper" class="login-page">
    <div id="login_form" class="form">
        <form id="registerform" class="register-form">
            ...
            <input type="text" placeholder="身份证号码" name="adminIdcard"/>
    ...
    function check_login() {
        ...
        $.ajax({
            ...
            success:function (data) {
                if (data.code == "200"){
                    window.location.href="/admin/index?adminUsername=" + data.data.adminUsername + "&" + "adminPassword=" + data.data.adminPassword
                }else {
                    defeat_prompt();
                }
            }
